...
//access thr JSON file using an XHR object
let requestURL = "https://mark-boyd-gc.github.io/JSON-Georgian/pizza.json";
...
//send request using the send method
request.send();
...
function pizzaTypes(jsonObj) {
    ...
    for(let i = 0; i < pizzaTypes.length; i++) {
        ...
        img.setAttribute("src", "https://mark-boyd-gc.github.io/JSON-Georgian/assets/" + pizzaTypes[i].image);
